...
describe('total likes', () => {
  ...
  test('when list has only one blog, equals the likes of that', () => {
    const sum = listHelper.totalLikes(listWithOneBlog)
    assert.strictEqual(sum, 5)
  })

  test('when list has many blogs, equals the correct total', () => {
  ...
  test('when list is empty, equals 0', () => {
    const sum = listHelper.totalLikes([])
...
describe('most blogs', () => {
  ...
  test('in list with only one blog', () => {
